    ...
    "definitions": {
        "model.Event": {
            ...
            "properties": {
                ...
                "images": {
                    "description": "Images ([]string): Array of image URLs associated with the event (e.g., event posters).",
                    "type": "string"
                },
                "is_featured": {
                ...
                "start_time": {
                    "description": "StartTime (time.Time): When the event is scheduled to begin.",
                    "type": "string"
                },
                "status": {

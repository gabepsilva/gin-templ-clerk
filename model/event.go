...
type Event struct {
	ID          uint   `json:"id" gorm:"primaryKey"`                // ID (uint): The unique identifier for the event, serves as the primary key.
	...
	User        User   `json:"-" gorm:"foreignKey:CreatedBy"`       // User (User): The user object associated with the event creator.
